...
namespace IFPS.Sales.Domain.Model
{
    public class FurnitureUnit : FullAuditedAggregateRoot<Guid>, IPricedEntity<FurnitureUnitPrice>, IMultiLingualEntity<FurnitureUnitTranslation>
    {
        ...
        /// <summary>
        /// The type of the furniture unit: wall cabinet or base and tall cabinet (by Offer form)
        /// </summary>
        public FurnitureUnitType FurnitureUnitType { get; set; }
        ...
        /// <summary>
        /// Is the furniture unit trending
        /// </summary>
        ...
        public FurnitureUnitTranslation CurrentTranslation => Translations.GetCurrentTranslation();
