...
namespace IFPS.Factory.Domain.Model
{
    public class Material : FullAuditedAggregateRoot<Guid>, IMultiLingualEntity<MaterialTranslation>, IPricedEntity<MaterialPrice>
    {
        ...
        private List<MaterialPackage> _packages;
        public IEnumerable<MaterialPackage> Packages => _packages.AsReadOnly();
        ...
        protected Material()
        {
            ...
            _packages = new List<MaterialPackage>();
        }
        ...
        public void AddMaterialPackageList(List<MaterialPackage> materialPackages)
        {
            Ensure.NotNull(materialPackages);
            _packages.AddRange(materialPackages);
        }

        public Material(string code) : this()
        {
            Code = code;
        }
    }
