...
{
    public class ManualLabourPlanByTypeCreateValidatorDto : AbstractValidator<ManualLabourPlanByTypeCreateDto>
    {
        public ManualLabourPlanByTypeCreateValidatorDto()
        {
