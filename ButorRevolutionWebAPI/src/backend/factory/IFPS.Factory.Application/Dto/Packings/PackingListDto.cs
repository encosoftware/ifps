...
namespace IFPS.Factory.Application.Dto
{
    public class PackingListDto
    {
        ...
        public PackingListDto(ProductionProcess productionProcess) 
        {
        ...
        public static Func<ProductionProcess, PackingListDto> FromEntity = entity => new PackingListDto(entity) { };
    }
}
