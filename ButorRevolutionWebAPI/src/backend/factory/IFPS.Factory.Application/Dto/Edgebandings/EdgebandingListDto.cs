...
{
    public class EdgebandingListDto
    {
        ...
        public EdgebandingListDto(ProductionProcess productionProcess)
        {
        ...
        public static Func<ProductionProcess, EdgebandingListDto> FromEntity = entity => new EdgebandingListDto(entity) { };
    }
}
