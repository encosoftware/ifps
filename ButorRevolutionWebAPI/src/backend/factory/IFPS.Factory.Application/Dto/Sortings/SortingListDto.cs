...
namespace IFPS.Factory.Application.Dto
{
    public class SortingListDto
    {
        ...
        public SortingListDto(ProductionProcess productionProcess)
        {
        ...
        public static Func<ProductionProcess, SortingListDto> FromEntity = entity => new SortingListDto(entity) { };
    }
}
